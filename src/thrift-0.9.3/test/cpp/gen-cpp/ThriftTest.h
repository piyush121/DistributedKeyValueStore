...
class ThriftTestConcurrentClientT : virtual public ThriftTestIf {
 public:
  ThriftTestConcurrentClientT(boost::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  ThriftTestConcurrentClientT(boost::shared_ptr< Protocol_> iprot, boost::shared_ptr< Protocol_> oprot) {
    setProtocolT(iprot,oprot);
  }
 private:
  void setProtocolT(boost::shared_ptr< Protocol_> prot) {
...
class ThriftTestCobClIfT {
 public:
   ...
   * @param thing
   */
  virtual void testBool(tcxx::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const bool thing) = 0;
   ...
   * @param thing
   */
  virtual void testBinary(tcxx::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing) = 0;
...
class ThriftTestCobSvIf {
 public:
   ...
   * @param thing
   */
  virtual void testBool(tcxx::function<void(bool const& _return)> cob, const bool thing) = 0;
   ...
   * @param thing
   */
  virtual void testBinary(tcxx::function<void(std::string const& _return)> cob, const std::string& thing) = 0;
...
class ThriftTestCobSvNull : virtual public ThriftTestCobSvIf {
 public:
  ...
  void testBool(tcxx::function<void(bool const& _return)> cob, const bool /* thing */) {
    bool _return = false;
    return cob(_return);
  }
  ...
  void testBinary(tcxx::function<void(std::string const& _return)> cob, const std::string& /* thing */) {
    std::string _return;
    return cob(_return);
  }
...
class ThriftTestCobClientT : virtual public ThriftTestCobClIfT<Protocol_> {
 public:
  ...
  void send_testString(const std::string& thing);
  void recv_testString(std::string& _return);
  void testBool(tcxx::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const bool thing);
  void send_testBool(const bool thing);
  bool recv_testBool();
  ...
  void send_testDouble(const double thing);
  double recv_testDouble();
  void testBinary(tcxx::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing);
  void send_testBinary(const std::string& thing);
  void recv_testBinary(std::string& _return);
...
class ThriftTestAsyncProcessorT : public ::apache::thrift::async::TAsyncDispatchProcessorT<Protocol_> {
 ...
 private:
  ...
  void process_testBool(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  ...
  void return_testBool(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const bool& _return);
  ...
  void throw_testBool(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  ...
  void process_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void process_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void return_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  void throw_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void throw_testBinary(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
