...
struct qt_meta_stringdata_apache__thrift__async__TQTcpServer_t {
    QByteArrayData data[5];
    char stringdata0[77];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_apache__thrift__async__TQTcpServer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_apache__thrift__async__TQTcpServer_t qt_meta_stringdata_apache__thrift__async__TQTcpServer = {
    {
QT_MOC_LITERAL(0, 0, 34), // "apache::thrift::async::TQTcpS..."
QT_MOC_LITERAL(1, 35, 15), // "processIncoming"
QT_MOC_LITERAL(2, 51, 0), // ""
QT_MOC_LITERAL(3, 52, 11), // "beginDecode"
QT_MOC_LITERAL(4, 64, 12) // "socketClosed"

    },
    "apache::thrift::async::TQTcpServer\0"
    "processIncoming\0\0beginDecode\0socketClosed"
};
...
const QMetaObject apache::thrift::async::TQTcpServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_apache__thrift__async__TQTcpServer.data,
      qt_meta_data_apache__thrift__async__TQTcpServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *apache::thrift::async::TQTcpServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_apache__thrift__async__TQTcpServer.stringdata0))
