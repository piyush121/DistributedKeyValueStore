...
void TestUnion::printTo(std::ostream& out) const {
  ...
  out << ", " << "i32_field=" << to_string(i32_field);
  out << ", " << "struct_field=" << to_string(struct_field);
  out << ", " << "struct_list=" << to_string(struct_list);
  out << ", " << "other_i32_field=" << to_string(other_i32_field);
  out << ", " << "enum_field=" << to_string(enum_field);
  out << ", " << "i32_set=" << to_string(i32_set);
  out << ", " << "i32_map=" << to_string(i32_map);
  out << ")";
}
