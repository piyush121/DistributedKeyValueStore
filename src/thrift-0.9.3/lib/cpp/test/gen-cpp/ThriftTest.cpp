        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i307 = 0; _i307 < _size303; ++_i307)
            {
              ...
              std::string& _val309 = this->thing[_key308];
...
uint32_t ThriftTest_testStringMap_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    for (_iter310 = this->thing.begin(); _iter310 != this->thing.end(); ++_iter310)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            xfer += iprot->readSetBegin(_etype330, _size327);
            uint32_t _i331;
            for (_i331 = 0; _i331 < _size327; ++_i331)
            {
              int32_t _elem332;
              xfer += iprot->readI32(_elem332);
              this->thing.insert(_elem332);
            }
...
uint32_t ThriftTest_testSet_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_SET, 1);
  {
    ...
    std::set<int32_t> ::const_iterator _iter333;
    for (_iter333 = this->thing.begin(); _iter333 != this->thing.end(); ++_iter333)
    {
...
uint32_t ThriftTest_testSet_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>((*(this->thing)).size()));
    std::set<int32_t> ::const_iterator _iter334;
    for (_iter334 = (*(this->thing)).begin(); _iter334 != (*(this->thing)).end(); ++_iter334)
    {
...
uint32_t ThriftTest_testSet_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_SET, 0);
    {
      ...
      std::set<int32_t> ::const_iterator _iter341;
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            xfer += iprot->readSetBegin(_etype345, _size342);
            uint32_t _i346;
            for (_i346 = 0; _i346 < _size342; ++_i346)
            {
              int32_t _elem347;
              xfer += iprot->readI32(_elem347);
              (*(this->success)).insert(_elem347);
            }
            xfer += iprot->readSetEnd();
          }
          this->__isset.success = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->thing.resize(_size348);
            uint32_t _i352;
            for (_i352 = 0; _i352 < _size348; ++_i352)
            {
              xfer += iprot->readI32(this->thing[_i352]);
            }
...
uint32_t ThriftTest_testList_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter353 = this->thing.begin(); _iter353 != this->thing.end(); ++_iter353)
    {
...
uint32_t ThriftTest_testList_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("thing", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter354 = (*(this->thing)).begin(); _iter354 != (*(this->thing)).end(); ++_iter354)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI32(this->success[_i359]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readI32((*(this->success))[_i365]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.success = true;
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->thing = (Numberz::type)ecast366;
          this->__isset.thing = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (Numberz::type)ecast367;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (Numberz::type)ecast368;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key374;
              xfer += iprot->readI32(_key374);
              std::map<int32_t, int32_t> & _val375 = this->success[_key374];
              {
                _val375.clear();
                uint32_t _size376;
                ...
                {
                  int32_t _key381;
                  xfer += iprot->readI32(_key381);
                  int32_t& _val382 = _val375[_key381];
                  xfer += iprot->readI32(_val382);
                }
                xfer += iprot->readMapEnd();
              }
            }
...
uint32_t ThriftTest_testMapMap_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_MAP, 0);
    {
      ...
      std::map<int32_t, std::map<int32_t, int32_t> > ::const_iterator _iter383;
      for (_iter383 = this->success.begin(); _iter383 != this->success.end(); ++_iter383)
      {
        xfer += oprot->writeI32(_iter383->first);
        {
          xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_I32, static_cast<uint32_t>(_iter383->second.size()));
          std::map<int32_t, int32_t> ::const_iterator _iter384;
          for (_iter384 = _iter383->second.begin(); _iter384 != _iter383->second.end(); ++_iter384)
          {
            xfer += oprot->writeI32(_iter384->first);
            xfer += oprot->writeI32(_iter384->second);
          }
          xfer += oprot->writeMapEnd();
        }
      }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int32_t _key390;
              xfer += iprot->readI32(_key390);
              std::map<int32_t, int32_t> & _val391 = (*(this->success))[_key390];
              {
                _val391.clear();
                uint32_t _size392;
                ...
                for (_i396 = 0; _i396 < _size392; ++_i396)
                {
                  ...
                  int32_t& _val398 = _val391[_key397];
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              UserId _key404;
              xfer += iprot->readI64(_key404);
              std::map<Numberz::type, Insanity> & _val405 = this->success[_key404];
              {
                _val405.clear();
                uint32_t _size406;
                ...
                {
                  Numberz::type _key411;
                  int32_t ecast413;
                  xfer += iprot->readI32(ecast413);
                  _key411 = (Numberz::type)ecast413;
                  Insanity& _val412 = _val405[_key411];
...
uint32_t ThriftTest_testInsanity_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_MAP, 0);
    {
      ...
      std::map<UserId, std::map<Numberz::type, Insanity> > ::const_iterator _iter414;
      for (_iter414 = this->success.begin(); _iter414 != this->success.end(); ++_iter414)
      {
        xfer += oprot->writeI64(_iter414->first);
        {
          xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter414->second.size()));
          std::map<Numberz::type, Insanity> ::const_iterator _iter415;
          for (_iter415 = _iter414->second.begin(); _iter415 != _iter414->second.end(); ++_iter415)
          {
            xfer += oprot->writeI32((int32_t)_iter415->first);
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              int16_t _key436;
              xfer += iprot->readI16(_key436);
              std::string& _val437 = this->arg3[_key436];
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->arg4 = (Numberz::type)ecast438;
...
uint32_t ThriftTest_testMulti_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("arg3", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    std::map<int16_t, std::string> ::const_iterator _iter439;
    for (_iter439 = this->arg3.begin(); _iter439 != this->arg3.end(); ++_iter439)
    {
      xfer += oprot->writeI16(_iter439->first);
...
uint32_t ThriftTest_testMulti_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I16, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>((*(this->arg3)).size()));
    std::map<int16_t, std::string> ::const_iterator _iter440;
    for (_iter440 = (*(this->arg3)).begin(); _iter440 != (*(this->arg3)).end(); ++_iter440)
    {
      xfer += oprot->writeI16(_iter440->first);
