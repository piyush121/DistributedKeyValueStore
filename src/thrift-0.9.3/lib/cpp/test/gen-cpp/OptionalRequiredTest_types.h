...
inline std::ostream& operator<<(std::ostream& out, const OldSchool& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Simple& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Tricky1& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Tricky2& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Tricky3& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const OptionalDefault& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const ManyOpt& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const JavaTestHelper& obj)
{
  obj.printTo(out);
  return out;
}
